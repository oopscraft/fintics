...
//// tide macd
//List<Macd> tideMacds = Tool.calculate(assetIndicator.getOhlcvs(Ohlcv.Type.MINUTE, 15), MacdContext.DEFAULT)
//def tideMacd = tideMacds.first()
//
//// wave macd
//List<Macd> waveMacds = Tool.calculate(assetIndicator.getOhlcvs(Ohlcv.Type.MINUTE, 3), MacdContext.DEFAULT)
