...
public interface DataMapper {
    ...
    List<AssetOhlcvSummary> selectAssetOhlcvSummaries(@Param("assetId") String assetId);

    List<IndiceOhlcvSummary> selectIndiceOhlcvSummaries(@Param("indiceId")Indice.Id indiceId);
