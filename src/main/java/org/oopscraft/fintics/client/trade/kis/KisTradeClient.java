...
import org.oopscraft.fintics.client.trade.KrTradeClient;
...
@Slf4j
public class KisTradeClient extends KrTradeClient {
    ...
    public KisTradeClient(TradeClientDefinition definition, Properties config) {
