...
// USD/KRW minute 3 (환율 하락 시 매수)
def resultOfUsdKrwMinute3 = analyze(indiceIndicators['USD_KRW'], OhlcvType.MINUTE, 3)
holdVotes.addAll(resultOfUsdKrwMinute3.values().collect{100 - (it as Number)})
...
// Nasdaq Future minute 3 (나스닥 선물 상승 시 매수)
def resultOfNdxFutureMinute3 = analyze(indiceIndicators['NDX_FUTURE'], OhlcvType.MINUTE, 3)
holdVotes.addAll(resultOfNdxFutureMinute3.values())
